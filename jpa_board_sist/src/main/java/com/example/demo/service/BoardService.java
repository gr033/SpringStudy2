...
public class BoardService {
	...
	public List<Board> findWriter(int start, int end, String id){
		return dao.selectWriter(start, end, id);
	}
	...
	public int selectWriter(String id) {
		return dao.countWriter(id);
	}
