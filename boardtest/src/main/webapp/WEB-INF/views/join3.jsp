...
$(function(){
	...
	$("#btnConfirmPhone").click(function(){
...
<body>
	<h2>회원가입</h2>
		<div id="box_phone">
		휴대폰 번호: <input type="tel" name="checkPhone" id="checkPhone">
		<button id="btnCheckPhone">인증</button><br>
		</div>
	
		<div id="box_check">
			인증번호 입력: <input type="text" name="checkNUM" id="checkNUM">
			<button id="btnConfirmPhone">확인</button>
		</div>
		<div id="box_insert">
		<form action="join" method="post">
				...
				핸드폰 번호: <input type="tel" name="phone" id="phone" readonly="readonly"><br>
